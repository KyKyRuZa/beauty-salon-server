...
const applySecurityMiddleware = (app) => {
  ...
  //       imgSrc: ["'self'", "data:", "https:", "http://localhost:5000", "http://localhost:5173", "blob:"],
  //       scriptSrc: ["'self'"],
  //       connectSrc: ["'self'", process.env.API_URL || "http://localhost:5000", "http://localhost:5173", "ws://localhost:5173"]
  //     }
  //   },
  //   hsts: {
  //     maxAge: 31536000,
