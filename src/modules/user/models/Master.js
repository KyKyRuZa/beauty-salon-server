...
const Master = sequelize.define(
  ...
  },
  {
    ...
    indexes: [
      ...
      {
        fields: ['user_id'],
        name: 'masters_user_id_idx',
      },
      {
        fields: ['specialization'],
        name: 'masters_specialization_idx',
      },
      {
        fields: ['salon_id'],
        name: 'masters_salon_id_idx',
      },
      {
        fields: ['rating'],
        name: 'masters_rating_idx',
      },
      {
        fields: ['has_training'],
        name: 'masters_has_training_idx',
      },
      {
        fields: ['first_name', 'last_name'],
        name: 'masters_name_idx',
      },
    ],
    paranoid: true,
    timestamps: true,
